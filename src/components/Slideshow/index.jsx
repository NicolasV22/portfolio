...
import '../../styles/Slideshow.scss';
    ...
    function Slideshow({project}) {
        ...
        const nextSlide = () => {
            setCurrentSlide((currentSlide + 1) % project.pictures.length);
        };
    
        const prevSlide = () => {
            setCurrentSlide((currentSlide - 1 + project.pictures.length) % project.pictures.length);
        };
            ...
            <div className='slideshow'>
                {project.pictures.length > 1 && (
                    <div className='slideshow__nav'>
                        ...
                        <span className='slideshow__nav__count'>{currentSlide + 1}/{project.pictures.length}</span>
                ...
                <div className='slideshow__img--container'>
                    <img className='slideshow__img' src ={project.pictures[currentSlide]} alt={`Slide ${currentSlide}`} />
                </div>
            </div>
        );
    }
